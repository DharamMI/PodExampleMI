...
This CocoaPods library helps you perform calculation.
  ...
  # Or just: spec.author    = "Dharamraj"
  # spec.authors            = { "Dharamraj" => "dharamrajsinh.jadeja@mindinventory.com" }
  # spec.social_media_url   = "https://twitter.com/Dharamraj"
  ...
  spec.source       = { :git => "https://github.com/DharamMI/PodExampleMI", :tag => "#{spec.version}" }
